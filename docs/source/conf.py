...
htmlhelp_basename = 'SpectraToolsdoc'
...
latex_documents = [
    (master_doc, 'SpectraTools.tex', 'SpectraTools Documentation',
...
man_pages = [
    (master_doc, 'spectratools', 'SpectraTools Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SpectraTools', 'SpectraTools Documentation',
     author, 'SpectraTools', 'One line description of project.',
     'Miscellaneous'),
]
